package com.hybriddevs.persiancalendar.calendar.persian;
...
public class CalendarTool {
    ...
    public String getPersianDayOfTheWeekName(int day) {
        return persianDayNames[day];
    }

    public String getPersianDayOfTheWeekShortNames(int day) {
        return persianDayShortNames[day];
    }
    ...
    private final String[] persianDayNames = {"شنبه", "یکشنبه", "دوشنبه", "سه شتبه", "چهارشنیه", "پنج شنبه", "جمعه"};
    private final String[] persianDayShortNames = {"ش", "ی", "د", "س", "چ", "پ", "ج"};
    private final String[] persianMonthNames = {"فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"};
