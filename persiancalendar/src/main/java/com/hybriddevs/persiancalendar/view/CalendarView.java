package com.hybriddevs.persiancalendar.view;
...
import com.hybriddevs.persiancalendar.R;
import com.hybriddevs.persiancalendar.calendar.persian.CalendarTool;
    ...
    private void assignClickHandlers() {
        ...
        btnNext.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*if (currentDatePersian.getIranianMonth() < 6) {
                    currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay());
                    //currentDatePersian.nextDay(31);
                } else if (currentDatePersian.getIranianMonth() == 6) {
                    if (currentDatePersian.getIranianDay() == 31) {
                        currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay() - 1);
                    } else {
                        currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay());
                    }
                } else if (currentDatePersian.getIranianMonth() < 11) {
                    currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay());
                } else if (currentDatePersian.getIranianMonth() == 11) {
                    if (currentDatePersian.IsLeap(currentDatePersian.getIranianYear())) {
                        currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay());
                    } else {
                        if (currentDatePersian.getIranianDay() == 30) {
                            currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay() - 1);
                        } else {
                            currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay());
                        }
                    ...
                    currentDatePersian.setIranianDate(currentDatePersian.getIranianYear() + 1, currentDatePersian.getIranianMonth() + 1, currentDatePersian.getIranianDay());
                }*/
        ...
        btnPrev.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                currentDate.add(Calendar.MONTH, -1);
                /*if (currentDatePersian.getIranianMonth() < 8 && currentDatePersian.getIranianMonth() > 1) {
                    currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() - 1, currentDatePersian.getIranianDay());
                } else if (currentDatePersian.getIranianMonth() <= 12 && currentDatePersian.getIranianMonth() != 1) {
                    currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() - 1, currentDatePersian.getIranianDay());
                } else if (currentDatePersian.getIranianMonth() == 1) {
                    if (currentDatePersian.IsLeap(currentDatePersian.getIranianYear())) {
                        if (currentDatePersian.getIranianDay() == 31) {
                            currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() - 1, currentDatePersian.getIranianDay() - 1);
                        } else {
                        ...
                        if (currentDatePersian.getIranianDay() == 31) {
                            currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() - 1, currentDatePersian.getIranianDay() - 2);
                        } else if (currentDatePersian.getIranianDay() == 30) {
                            currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() - 1, currentDatePersian.getIranianDay() - 1);
                        } else {
                            currentDatePersian.setIranianDate(currentDatePersian.getIranianYear(), currentDatePersian.getIranianMonth() - 1, currentDatePersian.getIranianDay());
                        }
